const PROYECTOS = [
  {
    ...
    comentarios:[
      {
        detalle: "Que buen proyecto 1", 
        puntaje: 4.0
      },
      {
        detalle: "Que buen proyecto 2", 
        puntaje: 5.0
      },
      {
        detalle: "Que buen proyecto 3", 
        puntaje: 4.0
      }
    ],
    telefono: '234324343',
    redesSociales:['Facebook','Twitter'],
    necesidades:['Dinero','Espacio','Bienes'],
    link:'https://ep01.epimg.net/elpais/imagenes/2016/03/13/planeta_futuro/1457868966_000530_1457870222_noticia_normal_recorte1.jpg'
  },
  { id: 2,
    organizacion: 'ONG-PERÚ',
    ...
    comentarios:[{detalle:'comentario1',puntaje:2.3},{detalle:'comentario2',puntaje:2.5}],
    telefono: '234324343',
    redesSociales:['Facebook','Twitter'],
    necesidades:['Dinero','Espacio','Bienes'],
    link:'https://mansunides.org/sites/default/files/proyecto-salud-america-ong-peru-acceso-agua-potable-01.jpg'
  },
  { id: 3,
    organizacion:'ONG-PERÚ',
